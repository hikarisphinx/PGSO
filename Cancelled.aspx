<%@ Page Title="PGSO Database" Language="C#" MasterPageFile="~/akshara.master" AutoEventWireup="true" CodeFile="Cancelled.aspx.cs" Inherits="Active" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <section id="services" class="bg-light-gray">
        ...
        RowStyle-BackColor="#A1DCF2" AlternatingRowStyle-BackColor="White" AlternatingRowStyle-ForeColor="#000">
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:PGSOConnectionString3 %>" SelectCommand="SELECT [Item Name] AS Item_Name, [Unit], [Quantity], [Description], [Unit Cost] AS Unit_Cost, [Total Amount] AS Total_Amount, [Accountable Person] AS Accountable_Person, [Office], [Position], [Transferred From] AS Transferred_From, [PAR Status] AS PAR_Status FROM [tblCancelled] WHERE ([Accountable Person] LIKE '%' + @Accountable_Person + '%')">
                    <SelectParameters>
                ...
                <h1 class="background double animated wow fadeInUp" data-wow-delay="4s" align="center"><strong>Cancelled Accountabilities</strong></h1>
            </div>
            <!-- ./ end row -->
