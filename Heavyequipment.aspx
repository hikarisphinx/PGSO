<%@ Page Title="PGSO Database" Language="C#" MasterPageFile="~/akshara.master" AutoEventWireup="true" CodeFile="Heavyequipment.aspx.cs" Inherits="Active" EnableEventValidation="false" %>
    ...
    <div id="banner">
        <div class="container">
            ...
            <h1 class="wow zoomIn animated" data-wow-duration="1500ms" data-wow-delay="100ms">
                       <strong><h2>LIST OF HEAVY EQUIPMENT</h2></strong>  
        </div>
    </div>
    <!-- Service Section -->
    ...
    <section id="services" class="bg-light-gray">
        ...
        <div class="container bg-light-gray">
            <div class="row bg-light-gray">
                ...
                <asp:GridView ID="GridView1" runat="server" OnPageIndexChanging="OnPageIndexChanging" AutoGenerateColumns="False" DataSourceID="SqlDataSource2" AllowSorting="True" CellPadding="3" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" HeaderStyle-BackColor="#3AC0F2" HeaderStyle-ForeColor="White"
        RowStyle-BackColor="#A1DCF2" AlternatingRowStyle-BackColor="White" AlternatingRowStyle-ForeColor="#000">
                <AlternatingRowStyle BackColor="White" ForeColor="#000000"></AlternatingRowStyle>   
                    ...
                    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:PGSOConnectionString %>" SelectCommand="SELECT [Item Name] AS Item_Name, [Quantity], [Plate No] AS Plate_No, [Date Acquired] AS Date_Acquired, [Purchased from] AS Purchased_from, [Description], [Unit Cost] AS Unit_Cost, [PAR No] AS PAR_No, [Accountable Person] AS Accountable_Person, [Position], [Office] FROM [Heavy Equipment]"></asp:SqlDataSource>
                </div>
                ...
                <br /><br /><br />
                <h3 align="center"></h3>
                <h1 class="background double animated wow fadeInUp" data-wow-delay="4s" align="center"><strong>HEAVY EQUIPMENTS</strong></h1>
            </div>
            <!-- ./ end row -->
