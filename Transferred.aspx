<%@ Page Title="PGSO Database" Language="C#" MasterPageFile="~/akshara.master" AutoEventWireup="true" CodeFile="Transferred.aspx.cs" Inherits="Active" EnableEventValidation="false" %>
        ...
        RowStyle-BackColor="#A1DCF2" AlternatingRowStyle-BackColor="White" AlternatingRowStyle-ForeColor="#000">
                <AlternatingRowStyle BackColor="White" ForeColor="#000000"></AlternatingRowStyle>   
                     <Columns>
                        ...
                        <asp:BoundField DataField="Transferred_to" HeaderText=" New Accountable Person " SortExpression="Transferred_to" />
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:PGSOConnectionString3 %>" SelectCommand="SELECT [Item Name] AS Item_Name, [Unit], [Quantity], [Description], [Unit Cost] AS Unit_Cost, [Total Amount] AS Total_Amount, [Transferred to] AS Transferred_to, [Office], [Position], [Transferred From] AS Transferred_From, [PAR Status] AS PAR_Status FROM [tblTransferred] WHERE ([Transferred From] LIKE '%' + @Transferred_From + '%')">
                    <SelectParameters>
                        <asp:ControlParameter ControlID="personsearch" Name="Transferred_from" PropertyName="Text" Type="String" />
                    </SelectParameters>
                </asp:SqlDataSource>

                <br /><br /><br />
                <h3 align="center">Currently Searching Employee on</h3>
                <h1 class="background double animated wow fadeInUp" data-wow-delay="4s" align="center"><strong>Transferred Accountabilities</strong></h1>
            </div>
            <!-- ./ end row -->
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <div class="sc-inner">
                        <h4>
                            <a href="Active.aspx" >Active</a></h4>
                        <p>
                            View property by "Active", base on accountable person's PAR Documents.</p>
                    </div>
                </div>
                <!-- ./ end service box -->
                <div class="col-md-4">
